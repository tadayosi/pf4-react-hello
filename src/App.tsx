import bgImageSrcFilter from '@patternfly/patternfly-next/assets/images/background-filter.svg';
import avatarImg from '@patternfly/patternfly-next/assets/images/img_avatar.svg';
import brandImg from '@patternfly/patternfly-next/assets/images/l_pf-reverse-164x11.png';
import bgImageSrcLg from '@patternfly/patternfly-next/assets/images/pfbg_1200.jpg';
import bgImageSrcXl from '@patternfly/patternfly-next/assets/images/pfbg_2000.jpg';
import bgImageSrcXs from '@patternfly/patternfly-next/assets/images/pfbg_576.jpg';
import bgImageSrcXs2x from '@patternfly/patternfly-next/assets/images/pfbg_576@2x.jpg';
import bgImageSrcSm from '@patternfly/patternfly-next/assets/images/pfbg_768.jpg';
import bgImageSrcSm2x from '@patternfly/patternfly-next/assets/images/pfbg_768@2x.jpg';
import bgImageSrcMd from '@patternfly/patternfly-next/assets/images/pfbg_992.jpg';
import bgImageSrcMd2x from '@patternfly/patternfly-next/assets/images/pfbg_992@2x.jpg';
...
class App extends React.Component<{}, IState> {
  ...
  public render() {
    ...
    const bgImages = {
      ...
      [BackgroundImageSrc.md]: bgImageSrcMd,
      [BackgroundImageSrc.md2x]: bgImageSrcMd2x,
